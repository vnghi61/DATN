                ...
                <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                    ...
                    <div class="flex justify-between items-center lg:p-4 p-2.5">
                        <div class="flex flex-1 items-center space-x-4">
                            <a href="#">
                                <img src="{{asset('clients/assets/images/avatars/avatar-2.jpg')}}" class="bg-gray-200 border border-white rounded-full w-10 h-10">
                            </a>
                    ...
                    <div uk-lightbox>
                        <a href="{{asset('clients/assets/images/avatars/avatar-lg-3.jpg')}}">
                            <img src="{{asset('clients/assets/images/avatars/avatar-lg-4.jpg')}}" alt="" class="max-h-96 w-full object-cover">
                        </a>
                    </div>
                        ...
                        <div class="border-t py-4 space-y-4 dark:border-gray-600">
                            <div class="flex">
                                <div class="w-10 h-10 rounded-full relative flex-shrink-0">
                                    <img src="{{asset('clients/assets/images/avatars/avatar-1.jpg')}}" alt="" class="absolute h-full rounded-full w-full">
                                </div>
                                <div>
                ...
                <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                    ...
                    <div uk-lightbox>
                        <div class="grid grid-cols-2 gap-2 px-5">
                            ...
                            <a href="{{asset('clients/assets/images/post/img-4.jpg')}}" class="col-span-2">
                                <img src="{{asset('clients/assets/images/post/img-4.jpg')}}" alt="" class="rounded-md w-full lg:h-76 object-cover">
                            </a>
                            <a href="{{asset('clients/assets/images/post/img-4.jpg')}}">
                                <img src="{{asset('clients/assets/images/post/img-2.jpg')}}" alt="" class="rounded-md w-full h-full">
                            </a>
                            <a href="{{asset('clients/assets/images/post/img-4.jpg')}}" class="relative">
                                <img src="{{asset('clients/assets/images/post/img-3.jpg')}}" alt="" class="rounded-md w-full h-full">
