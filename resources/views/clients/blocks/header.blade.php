        ...
        <div class="header_inner mcontainer">
            ...
            <div class="right_side">
                ...
                <div class="header_widgets">
                        ...
                        <div class="dropdown_scrollbar" data-simplebar>
                            ...
                            <ul>
                                ...
                                <li class="not-read">
                                    <a href="#">
                                        <div class="drop_avatar status-online"> <img
                                                src="{{ asset('clients/assets/images/avatars/avatar-2.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                            <p>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img
                                                src="{{ asset('clients/assets/images/avatars/avatar-3.jpg') }}"
                                                alt="">
                                        </div>
                                        <span class="drop_icon bg-gradient-primary">
                                            <i class="icon-feather-thumbs-up"></i>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img
                                                src="{{ asset('clients/assets/images/avatars/avatar-1.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                            <p>
                        ...
                        <div class="dropdown_scrollbar" data-simplebar>
                            ...
                            <ul>
                                <li class="un-read">
                                    <a href="#">
                                        <div class="drop_avatar"> <img
                                                src="{{ asset('clients/assets/images/avatars/avatar-7.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img
                                                src="{{ asset('clients/assets/images/avatars/avatar-4.jpg') }}"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                            <strong> Jonathan Madano </strong> <time> Sun</time>
                    ...
                    <a href="#">
                        {{-- <img src="https://img.thuthuatphanmem.vn/uploads/2018/09/19/avatar-facebook-chat-4_105604005.jpg" style="width:35px" class="is_avatar" alt=""> --}}
